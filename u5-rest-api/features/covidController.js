...
const readCovidRecord = async (req, res) => {
  try {
    ...
    if (!snapshot.exists) { return res.status(404).json({ response: 'not found' }) }
...
module.exports = { readCovidRecords, readCovidRecord, createCovidRecord, updateCovidRecord, deleteRecord }
