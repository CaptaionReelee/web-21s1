...
const { athleteCreateForm, athleteList, athleteDetails, athleteSchedule, athleteCreateByFrom } = require('./features/athletes-controller')
...
app.post('/athletes', athleteCreateByFrom)
